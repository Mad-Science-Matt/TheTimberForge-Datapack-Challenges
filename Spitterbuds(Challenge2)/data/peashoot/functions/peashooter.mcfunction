...
#firing projectiles
execute as @e[tag=peashooter,scores={PEAattacktime=1}] at @s if entity @e[tag=hostileMob,distance=..16] run summon minecraft:armor_stand ~ ~ ~ {Small:1b,Marker:1b,Invisible:1b,Tags:["PEAbullet"]}

execute as @e[tag=peashooter,scores={PEAattacktime=1}] at @s if entity @e[tag=hostileMob,distance=..16] run scoreboard players add @e[tag=peashooter] PEAlifetime 40

execute as @e[tag=peashooter,scores={PEAattacktime=1}] at @s if entity @e[tag=hostileMob,distance=..16] run playsound minecraft:entity.fox.spit hostile @p ~ ~ ~ 16
...
execute as @e[tag=peashooter] at @s if entity @e[type=item,nbt={Item:{id:"minecraft:bone_meal"}},distance=..2] run scoreboard players set @s PEAlifetime 0
...
execute as @e[type=item,nbt={Item:{id:"minecraft:bone_meal"}}] at @s if entity @e[tag=peashooter,distance=..2] run kill @s

execute as @e[tag=peashooter,scores={PEAlifetime=144000..}] at @s run setblock ~ ~ ~ minecraft:air replace



execute as @e[tag=peashooter] at @s unless block ~ ~-1 ~ minecraft:grass_block run kill @s

execute as @e[tag=peashooter] at @s unless block ~ ~ ~ minecraft:fern run kill @s
